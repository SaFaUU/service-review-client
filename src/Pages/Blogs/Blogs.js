...
const Blogs = () => {
    ...
    return (
        <div>
            <div className="card lg:card-side bg-base-100 shadow-xl w-2/3 mx-auto my-10 hover:scale-110 duration-300 ease-in-out">
                <img src="https://sazzadul.com/wp-content/uploads/2022/07/SQl-or-NoSQL.jpg" alt="Question Related" className='lg:w-1/3' />
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl w-2/3 mx-auto my-10 hover:scale-110 duration-300 ease-in-out">
                <img src="https://yami.io/wp-content/uploads/3/2020/01/jwt-1200x675.png" alt="Question Related" className='lg:w-1/3' />
                <div className="card-body">
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl w-2/3 mx-auto my-10 hover:scale-110 duration-300 ease-in-out">
                <img src="https://www.moweb.com/uploads/blogs/original/1651273914best-nodejs-frameworks.png" alt="Question Related" className='lg:w-1/3' />
                <div className="card-body">
            ...
            <div className="card lg:card-side bg-base-100 shadow-xl w-2/3 mx-auto my-10 hover:scale-110 duration-300 ease-in-out">
                <img src="https://www.cronj.com/blog/wp-content/uploads/Event-Loop.png" alt="Question Related" className='lg:w-1/3' />
                <div className="card-body">
