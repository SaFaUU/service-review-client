...
const Banner = () => {
    return (
        <div className="hero h-96" style={{ backgroundImage: `url("https://upload.wikimedia.org/wikipedia/commons/f/f1/Saint_Martins_Island_%28Bangladesh%29_banner_Beach_with_boats.jpg")` }}>
